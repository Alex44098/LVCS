...
#  Oct 21, 2024 09:49:12 PM +03  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 708x450+424+144
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
    ...
    button "$top.but49" \
        ...
        -highlightcolor #000000 -text "Создать" 
    vTcl:DefineAlias "$top.but49" "Button2" vTcl:WidgetProc "Toplevel1" 1
    button "$top.but48" \
        -activebackground #d9d9d9 -activeforeground black -background #d9d9d9 \
        -disabledforeground #a3a3a3 -font "-family {Segoe UI} -size 9" \
        -foreground #000000 -highlightbackground #d9d9d9 \
        -highlightcolor #000000 -text "Открыть" 
    vTcl:DefineAlias "$top.but48" "Button1" vTcl:WidgetProc "Toplevel1" 1
    ###################
    # SETTING GEOMETRY
    ###################
    place $top.scr47 \
        -in $top -x 0 -relx 0.014 -y 0 -rely 0.022 -width 0 -relwidth 0.708 \
        -height 0 -relheight 0.856 -anchor nw -bordermode ignore 
    place $top.but49 \
        -in $top -x 0 -relx 0.749 -y 0 -rely 0.2 -width 167 -relwidth 0 \
        -height 76 -relheight 0 -anchor nw -bordermode ignore 
    place $top.but48 \
        -in $top -x 0 -relx 0.749 -y 0 -rely 0.022 -width 167 -relwidth 0 \
